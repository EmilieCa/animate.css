...
const afficherGraphiqueDesFilms = () => {
    const bar = new RGraph.SVG.Bar({
        ...
        {maxWidth: null, width: 550, height:350,options:{labelsAboveSize: 12,textSize: 14},parentCss: {'float': 'none'}},
        {maxWidth: 800,  width: 400,height:200,options:{labelsAboveSize: 8,textSize: 10},parentCss: {'float': 'none'}}
    ]);
};
afficherGraphiqueDesFilms();
